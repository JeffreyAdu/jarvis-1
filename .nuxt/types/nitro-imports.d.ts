declare global {
  ...
  const assistant: typeof import('../../server/utils/openai')['assistant']
  ...
  const client: typeof import('../../server/utils/openai')['client']
  ...
  const getLatestMessages: typeof import('../../server/utils/get-message')['getLatestMessages']
...
export { getLatestMessages } from '../../server/utils/get-message';
export { client, assistant } from '../../server/utils/openai';